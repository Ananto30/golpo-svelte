...
<div in:fade class="md:min-h-screen md:flex sticky top-0 w-full md:w-auto z-10">
	<!-- mobile menu bar -->
	<div class="bg-gray-800 text-gray-100 flex justify-between md:hidden fixed w-full z-50">
		<!-- logo -->
	...
	<div
		...
		<!-- nav -->
		<nav class="text-xl bg-white grid gap-2">
			<a
				on:click={toggleSideBar}
				href="#/home"
				class="py-5 px-4 rounded-full transition duration-200 hover:bg-indigo-100 flex gap-2 items-center">
				<img
					alt=""
					width="36"
			...
			<a
				on:click={toggleSideBar}
				on:click={logout}
				class="py-5 px-4 rounded-full transition duration-200 hover:bg-indigo-100 cursor-pointer flex gap-2 items-center">
				<img
					width="36"
		...
		<hr />
		<div class="text-sm">
			<a class="cursor-pointer hover:underline text-indigo-500" href="https://github.com/Ananto30/golpo-svelte"
				>GitHub</a>
			•
			<a
				class="cursor-pointer hover:underline text-indigo-500"
