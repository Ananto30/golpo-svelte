...
<div class="{hide ? 'hidden' : 'fixed'} inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true">
	<div class="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
		...
		>
			<div class="bg-dark2 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
				<h3 class="text-lg font-semibold text-gray-900" id="modal-title">Update profile information</h3>
